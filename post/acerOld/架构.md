...
* [ Nginx开发从入门到精通 ——淘宝 nginx book]( https://github.com/taobao/nginx-book ),[方便阅读]( http://tengine.taobao.org/book/index.html )
* [可视化配置 Nginx]( https://www.digitalocean.com/community/tools/nginx )
